...
//  CentralWayFinder
//
//  Created by Suruchi on 15/09/2015.
...
class ViewController: UIViewController, CLLocationManagerDelegate, GMSMapViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        //let camera: GMSCameraPosition = GMSCameraPosition.cameraWithTarget(viewMap.myLocation.coordinate, zoom: 10)
        viewMap.camera = camera
        viewMap.delegate = self
        
        //viewMap.addObserver(self, forKeyPath: "myLocation", options: NSKeyValueObservingOptions.New, context: nil)
        //viewMap.addObserver(self, forKeyPath: "myLocation", options: NSKeyValueChangeNewKey, context: nil)
        ...
        //viewMap.region = MKCoordinateRegionMakeWithDistance(coordinate, 250, 250);
    ...
    //override func observeValueForKeyPath(keyPath: String, ofObject object: AnyObject, change: [NSObject : AnyObject], context: UnsafeMutablePointer<Void>) {
     override func observeValueForKeyPath(keyPath: String?, ofObject object: AnyObject?, change: [String : AnyObject]?, context: UnsafeMutablePointer<Void>) {
        if !didFindMyLocation {
            ...
            //var myLocation:CLLocation = change[NSKeyValueChangeNewKey] as! CLLocation
            
            
            viewMap.camera = GMSCameraPosition.cameraWithTarget(viewMap.myLocation.coordinate, zoom: 10.0)
            viewMap.settings.myLocationButton = true
